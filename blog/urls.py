...
from blog.views import IndexView,ArticleView,AllView,SearchView,ColumnView,UserView,NewsView,TagView,CategoryView,index,index2,index3
...
urlpatterns = [
        ...
        url(r'^blog/frame/$',index),
        url(r'^blog/frame2/$',index2),
         url(r'^blog/frame3/$',index3),
]
