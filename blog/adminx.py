#coding:utf-8
from blog.models import Article,Category,Carousel,Nav,Column,News,FrontPic,ClubIntro
...
xadmin.site.register(FrontPic,FrontPicAdmin)
xadmin.site.register(ClubIntro,ClubIntroAdmin)
